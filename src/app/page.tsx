...
import image5 from '@/images/photos/Screenshot 2024-09-04 at 17.43.58.png';
import image2 from '@/images/photos/Screenshot 2024-09-04 at 13.27.22.png';
import image4 from '@/images/photos/Fish_.png';
...
function Resume() {
  let resume: Array<Role> = [
    ...
    {
      company: 'Collaboration Messenger',
      title: 'Co-Founder',
      logo: logoTelerik,
      start: '11/2023',
      end: '12/2023',
    ...
    {
      company: 'Forum management system',
      title: 'Co-Founder',
      logo: logoTelerik,
      start: '10/2023',
      end: '11/2023',
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Nikolay, a software engineer and entrepreneur based in Bulgaria.
            I’m the co-founder of Chicagoboatparties, where we provide
            information and details about certain events, registration and
